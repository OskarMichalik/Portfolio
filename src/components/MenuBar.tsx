...
const MenuBar: React.FC<{
  ...
  return (
    <div className={classes.menuBarDiv}>
      <motion.div className={classes.openedAppsMenuBarDiv} layout>
        <AnimatePresence>
          {props.openedApps.includes("portfolio") && (
            <motion.div
              className={classes.barAppIcon}
              initial={{ scale: 0.5, opacity: 0 }}
              animate={{
                scale: 1,
                opacity: 1,
                backgroundColor:
                  props.location === "portfolio" ? "#ffffff81" : "#ffffff00",
              }}
        ...
        <AnimatePresence>
          {props.openedApps.includes("info") && (
            <motion.div
              className={classes.barAppIcon}
              initial={{ scale: 0.5, opacity: 0 }}
              animate={{
                ...
                opacity: 1,
                backgroundColor:
                  props.location === "info" ? "#ffffff81" : "#ffffff00",
              }}
              exit={{ scale: 0.5, opacity: 0 }}
              transition={{ duration: 0.2, bounce: 0 }}
              whileHover={{ backgroundColor: "#ffffff81" }}
