...
const Info: React.FC<{
  ...
  const ad = require("../../assets/ad.gif");
  ...
  function openAppFn(name: locationInterface) {
    ...
    if (!props.openedApps.includes(name))
      props.setOpenedApps((prev) => {
        return [...prev, name];
      });
  }

  function closeAd(event: React.MouseEvent<HTMLImageElement, MouseEvent>) {
  ...
  return (
    <motion.div
      ...
      animate={{
        scale: props.location === "info" ? 1 : 0,
        opacity: props.location === "info" ? 1 : 0,
      }}
    ...
    >
      ...
      />
      <motion.div
        className={classes.infoContentDiv}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
            ...
            <div className={classes.modalDiv}>
              ...
              >
                ...
                <div className={classes.modalContent}>
                  ...
                  <div className={classes.socialDiv}>
                    <a href="https://www.linkedin.com/in/oskar-michalik-552548311/">
          ...
          <div className={classes.mainInfo}>
            ...
            {adOpen && (
              <div className={classes.adDiv}>
                ...
                >
                  <img src={ad} alt="ad for my portfolio" />
                  <motion.img
                    src={closeIcon}
                    alt="close icon"
                    onClick={(e) => closeAd(e)}
                    className={classes.closeAdIcon}
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 1 }}
                  />
                </div>
          ...
          <div className={classes.achievementsDiv}>
            ...
            >
              ...
              <motion.svg
                ...
                width="10.605"
                height="15.555"
                animate={{ rotate: achievementsOpen ? 270 : 90 }}
              >
          ...
          <div className={classes.skillsDiv}>
            ...
            >
              ...
              <motion.svg
                ...
                width="10.605"
                height="15.555"
                animate={{ rotate: skillsOpen ? 270 : 90 }}
              >
                <path d="m2.828 15.555 7.777-7.779L2.828 0 0 2.828l4.949 4.948L0 12.727l2.828 2.828z" />
              </motion.svg>
            </div>
